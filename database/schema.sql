...
-- =============================================================================
-- 054_fix_active_league_closure.sql (mirrored migration)
-- =============================================================================
Exit code: 0
...
-- =============================================================================
-- 055_fix_scheduled_season_transitions.sql (mirrored migration)
-- =============================================================================
Exit code: 0
Wall time: 0.5 seconds
Output:
...
-- =============================================================================
-- Миграция 065 (Stage 5): сон питомца — вторая, бесплатная ось заботы.
-- get_pet_state ниже ПЕРЕОПРЕДЕЛЯЕТ версию из 064 (в снимке побеждает последнее определение).
-- =============================================================================
-- --- 1. Конфигурация -----------------------------------------------------------
...
-- =============================================================================
-- Миграция 066: у общего настроения появился собственный код усталости.
-- До неё сытому, но не выспавшемуся питомцу подставлялся код голода. Определение ниже
-- ПЕРЕОПРЕДЕЛЯЕТ версию из 065 (в снимке побеждает последнее определение).
-- =============================================================================
create or replace function public.get_pet_state(p_student_id bigint)
 returns json
 language plpgsql
...
-- =============================================================================
-- Миграция 068 (PET1): оси внимания и игры, связь, read-модель комнаты.
-- feed_pet и put_pet_to_sleep ниже ПЕРЕОПРЕДЕЛЯЮТ версии из 064/065 — добавлен вызов
-- pet_touch_bond. Связь считает дни с заботой, а не количество нажатий.
-- =============================================================================
...
-- =============================================================================
-- Миграция 069 (PET4): вторая ступень питомца.
-- get_pet_state и get_pet_room ниже ПЕРЕОПРЕДЕЛЯЮТ версии из 066/068 — добавлены ступень и
-- блок эволюции. Условие: 1500 бубликов И 60 дней заботы по bond; обе оси обязательны.
-- =============================================================================
